        ...
        <div class="col-md-6 text-center text-lg-end">
            <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                <div class="me-3 pe-3 border-end py-2">
                    <p class="m-0"><i class="fa fa-envelope-open me-2"></i>pdp@gmail.com</p>
                </div>
                <div class="py-2">
                    <p class="m-0"><i class="fa fa-phone-alt me-2"></i>+99894 242 27 44</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <a href="/views/userPages/appointment.jsp" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn"
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 wow zoomIn" data-wow-delay="0.6s">
                <div class="offer-text text-center rounded p-5">
                    ...
                    <a href="/views/userPages/appointment.jsp" class="btn btn-dark py-3 px-5 me-3">Appointment</a>
        ...
        <div class="row g-5">
            <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                <div class="section-title bg-light rounded h-100 p-5">
                    ...
                    <a href="/views/userPages/appointment.jsp" class="btn btn-primary py-3 px-5">Appointment</a>
                </div>
            </div>
