...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="/views/userPages/appointment.jsp" class="btn btn-primary py-2 px-4 ms-3">Appointment</a>
    </div>
</nav>
<!-- Navbar End -->
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <a href="/views/userPages/appointment.jsp" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Make
                    Appointment</a>
            </div>
