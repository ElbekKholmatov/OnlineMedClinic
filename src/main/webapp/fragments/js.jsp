<section>
    ...
    <script src="${pageContext.request.contextPath}/resources/lib/twentytwenty/jquery.event.move.js"></script>
    <script src="${pageContext.request.contextPath}/resources/lib/twentytwenty/jquery.twentytwenty.js"></script>
</section>